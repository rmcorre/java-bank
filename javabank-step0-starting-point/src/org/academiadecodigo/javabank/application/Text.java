...
public class Text {
    ...
    public final static String MENU_WELCOME = "Welcome to JavaBank";
    ...
    public final static String INSERT_CUSTOMER_ID = "Please insert your customer ID: ";
    public final static String BALANCE_MESSAGE = " balance: ";
    public final static String CREATED_ACCOUNT = "Created account for ";
    public final static String OPEN_ACCOUNTS_LIST = "You have the following accounts: ";
    ...
    public final static String ERROR_INVALID_CUSTOMER_ID = "Invalid customer ID";
